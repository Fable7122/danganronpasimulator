...
round = 1
murderchance = 20
murdermethod = [" was stabbed to death", " was strangled to death", " was pushed and fell to their death", " was poisoned", " was shot in the heart", " was electrocuted", " was bludgeoned to death", " was burned to death", " died to blood loss"]
safe = [" used the MonoMono machine", " ate a snack in the cafeteria", " took a walk around the school", " talked to another student", " took a rest in their dorm", " swam laps in the pool", " tried to find an exit (unsuccessfully)", " stood menacingly in the halls, looking at the mc constantly"]
endingready = False
